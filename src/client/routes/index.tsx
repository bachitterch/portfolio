...
function Home() {
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 flex items-center justify-center px-8">
        <div>
          ...
          <div className="mt-4 w-full">
            ...
            <p className="mt-6 w-full max-w-[80ch]">
          ...
          <div className="mt-6 flex w-full items-center gap-6">
            ...
            <a
              target="blank"
              href="https://github.com/bachitterch"
              aria-label="Github"
              className="group"
            >
              <svg
            ...
            <a
              target="blank"
              href="https://linkedin.com/in/bachitterch"
              aria-label="LinkedIn"
              className="group"
            >
              <svg
            ...
            <a
              ...
              aria-label="Email Me"
              className="rounded-lg border border-neutral-200 bg-neutral-100 px-1.5 py-0.5 text-sm font-medium text-neutral-500 hover:text-neutral-600"
            >
              Email me
            </a>
          </div>
